	...
	<v-app id="inspire">
		...
		<v-app-bar class="px-3" color="grey-lighten-4" flat height="72">
			...
			<v-responsive max-width="156">
				<v-text-field bg-color="grey-lighten-1" density="compact" flat hide-details rounded="pill" variant="solo-filled"></v-text-field>
			</v-responsive>
		</v-app-bar>
		<v-main><!--  --></v-main>
		...
		<v-footer app height="72">
			<v-text-field bg-color="grey-lighten-1" class="overflow-hidden" density="compact" flat hide-details rounded="pill" variant="solo-filled"></v-text-field>
		</v-footer>
	</v-app>
</template>
