<template>
	<v-card class="mx-auto" max-width="400">
		...
		<v-card-text class="pt-4">
			...
			nobis a at voluptates culpa optio amet! Inventore deserunt
			voluptatem maxime a veniam placeat, eos impedit nulla quos?
			Officiis, aperiam ducimus.
		</v-card-text>
		...
		computed: {
			items() {
				...
				return Array.from({ length: 10000 }, () => {
					...
					const surname =
						this.surnames[this.genRandomIndex(surnamesLength)];
