<template>
	<div>
		...
		<v-alert color="#C51162" theme="dark" icon="mdi-material-design" border>
			Phasellus blandit leo ut odio. Morbi mattis ullamcorper velit. Donec
			orci lectus, aliquam ut, faucibus non, euismod id, nulla. In ut quam
			vitae odio lacinia tincidunt.
		</v-alert>

		<br />

		<v-alert color="primary" theme="dark" icon="$vuetify" prominent>
			Praesent congue erat at massa. Nullam vel sem. Aliquam lorem ante,
			dapibus in, viverra quis, feugiat a, tellus. Proin viverra, ligula
			sit amet ultrices semper, ligula arcu tristique sapien, a accumsan
			nisi mauris ac eros. Curabitur at lacus ac velit ornare lobortis.
		</v-alert>
	</div>
</template>
