<template>
	...
	>
		...
		<p class="mb-8">
			...
			media properties and across the internet. We may collect data that
			you submit to us directly or data that we collect automatically
			...
			Please read our
			<a href="#" class="text-red-accent-2">Privacy Policy</a> to learn
